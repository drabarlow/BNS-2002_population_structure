...
```{r, out.width = "100%", dpi = 300, echo = FALSE, fig.align = "center", fig.cap = ""}
  include_graphics("./assets/img/fst1.svg")
```
...
```{r, out.width = "100%", dpi = 300, echo = FALSE, fig.align = "center", fig.cap = ""}
  include_graphics("./assets/img/fst2.svg")
```
...
```{r, out.width = "100%", dpi = 300, echo = FALSE, fig.align = "center", fig.cap = ""}
  include_graphics("./assets/img/fst3.svg")
```
...
```{r, out.width = "100%", dpi = 300, echo = FALSE, fig.align = "center", fig.cap = ""}
include_graphics("./assets/img/cro.png")
```
...
```{r, out.width = "100%", out.height=500, dpi = 300, echo = FALSE, fig.cap = ""}
  include_graphics("./assets/img/Fennessy et al. - 2016 - Multi-locus Analyses Reveal Four Giraffe Species Instead of One.pdf")
```
...
```{r, out.width = "100%", out.height=500, dpi = 300, echo = FALSE, fig.cap = ""}
  include_graphics("./assets/img/Bercovitch et al. - 2017 - How many species of giraffe are there.pdf")
```
